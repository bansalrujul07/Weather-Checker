...
function App() {
  ...
  const api_key = "b6a934b7ddfacaa5f95f0f9efcdbc267";
  ...
  //only triggers search if input is empty
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-2xl mx-4 p-10 rounded-3xl 
      backdrop-blur-sm bg-white/10 border border-white/20 shadow-2xl min-h-[350px]">

          <div className="flex flex-col justify-center items-center gap-6 ">

            <h1 className="text-4xl font-serif font-semibold">Weather Check</h1>
            ...
            {history.length > 0 && (
              <div className="mt-4 w-full">
                <h2 className="text-xl font-semibold mb-2">Last Searched Cities:</h2>
